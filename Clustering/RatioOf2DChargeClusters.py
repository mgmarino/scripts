...
def main(files,nbins,rng,zCut):
  ...
  t.Draw("fChargeClusters.fCorrectedEnergy>>hFullSS("+binstring+",0,"+str(rng)+")","fChargeClusters.fCorrectedEnergy < "+str(rng)+" && abs(fChargeClusters.fZ) < "+str(zCut)+" && abs(Sum$(fChargeClusters.fRawEnergy) - Max$(fChargeClusters.fRawEnergy)) < 1","goff")
  t.Draw("fChargeClusters.fCorrectedEnergy>>hGoodSS("+binstring+",0,"+str(rng)+")","fChargeClusters.fCorrectedEnergy < "+str(rng)+" && abs(fChargeClusters.fX) < 172 && abs(fChargeClusters.fZ) < "+str(zCut)+" && abs(Sum$(fChargeClusters.fRawEnergy) - Max$(fChargeClusters.fRawEnergy)) < 1.","goff")
